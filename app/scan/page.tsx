    ...
    <AppShell>
      ...
      <div className="py-10">
        <div className="mx-auto flex max-w-md flex-col items-center gap-3 rounded-2xl bg-card p-10 text-center shadow-card">
          <div className="grid h-16 w-16 place-items-center rounded-full bg-[#EEF0FB] text-[#306FD7]">
          ...
          <button className="mt-2 rounded-full bg-[#306FD7] px-5 py-2.5 text-sm font-semibold text-white">
            Open Camera
          </button>
        </div>
      </div>
