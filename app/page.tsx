...
const SliderBanner = dynamic(() => import("@/components/ui/slider-banner").then((m) => ({ default: m.SliderBanner })), { ssr: false, loading: SliderBannerSkeleton })
const CategoryProductsSections = dynamic(() => import("@/components/home/category-products-sections").then((m) => ({ default: m.CategoryProductsSections })), { ssr: false })
const YoutubeVideoSection = dynamic(() => import("@/components/home/youtube-video-section").then((m) => ({ default: m.YoutubeVideoSection })), { ssr: false })
const FloatingRotatingIcon = dynamic(() => import("@/components/home/floating-rotating-icon").then((m) => ({ default: m.FloatingRotatingIcon })), { ssr: false })
