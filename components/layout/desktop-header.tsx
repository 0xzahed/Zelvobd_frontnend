        ...
        <div className='mx-auto flex h-20 max-w-7xl items-center gap-4 px-6 transition-all duration-300'>
          ...
          {searchOpen ? (
            ...
            <nav className='flex min-w-0 flex-1 items-center justify-center px-4'>
              <div className='flex items-center gap-1 rounded-full bg-secondary/50 p-1.5 shadow-inner backdrop-blur-md border border-border/50 overflow-x-auto scrollbar-none [&::-webkit-scrollbar]:hidden'>
          ...
          <div className='flex shrink-0 items-center gap-3'>
            <button
              ...
              className={`group flex h-11 w-11 items-center justify-center rounded-full border border-border/50 bg-background shadow-sm transition-all duration-300 hover:shadow-md hover:border-border ${
                searchOpen
                  ? 'ring-2 ring-primary/20 text-primary'
            ...
            >
              ...
              {totalCount > 0 && (
                <span className='absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-primary px-1.5 text-[10px] font-bold text-primary-foreground shadow-sm ring-2 ring-background'>
                  {totalCount}
                </span>
              )}
            </button>
