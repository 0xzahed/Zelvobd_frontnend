...
import { FreeDeliveryAdminResponse, useUpdateFreeDeliveryProducts } from "@/src/hooks/api/useFreeDelivery"
...
export function FreeDeliveryProducts({ adminData }: Props) {
    ...
    <div className="rounded-xl border bg-card p-6 shadow-sm">
      <div className="flex items-center justify-between border-b pb-4 mb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Select products to offer with free delivery.</p>
        </div>
        <Button 
