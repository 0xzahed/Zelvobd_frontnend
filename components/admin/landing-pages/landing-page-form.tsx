  ...
  const {
    ...
    defaultValues: initialData || {
      ...
      videoSection: {
        ...
        videoLink: '',
        customThumbnail: '',
        cards: [{ icon: 'check', title: '', subtitle: '' }],
      },
    ...
    <div className='space-y-4'>
      <div>
        ...
        <p className='text-xs text-muted-foreground mt-1'>
          Leave empty to type your own, or type normally to auto-format.
        </p>
      </div>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
      ...
      <div className='flex flex-col-reverse sm:flex-row justify-end gap-3'>
        <button
          type='button'
          onClick={() => router.back()}
          className='w-full sm:w-auto px-4 py-2 text-sm font-medium rounded-full border border-input bg-background hover:bg-accent hover:text-accent-foreground text-center'
        >
          Cancel
        </button>
