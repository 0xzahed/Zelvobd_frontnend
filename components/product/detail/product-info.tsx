...
export function ProductInfo({
  ...
  const [activeTab, setActiveTab] = useState<'specification' | 'description' | 'warranty'>(
    'description',
  );
  ...
  useEffect(() => {
    ...
    if (!el || activeTab !== 'description') return;

    const checkHeight = () => {
      // 350px represents roughly 2-3 paragraphs of text
              ...
              <div>
                ...
                <div className='relative'>
                  <div
                    ...
                    className={cx(
                      ...
                      !isDescExpanded ? 'max-h-87.5' : 'max-h-20000',
                    )}
                  >
                    <QuillEditor
                      readOnly
                ...
                {showSeeMore && (
                  <button
                    ...
                    className='mt-3 text-sm font-semibold text-primary hover:underline focus:outline-none'
                  >
