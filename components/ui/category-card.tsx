...
export function CategoryCard({ category }: { category: Category }) {
  return (
    <Link
      ...
      className="flex flex-col overflow-hidden rounded-lg bg-card p-1.5 shadow-sm transition hover:-translate-y-0.5 md:rounded-md md:p-1"
    >
      <div className="relative aspect-square w-full overflow-hidden rounded-md md:rounded-sm">
        <Image
