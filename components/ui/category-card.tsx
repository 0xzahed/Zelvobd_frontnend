...
export function CategoryCard({ category }: { category: Category }) {
  return (
    <Link
      ...
      className="flex aspect-square w-full flex-col overflow-hidden rounded-sm bg-card p-[1px] shadow-sm transition hover:-translate-y-0.5"
    >
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 items-center justify-center overflow-hidden rounded-sm bg-card">
        <div className="grid h-12 w-12 grid-cols-2 grid-rows-2 place-items-center gap-1 rounded-full bg-secondary p-2 md:h-[52px] md:w-[52px]">
